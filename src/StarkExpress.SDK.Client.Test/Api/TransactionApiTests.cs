...
namespace StarkExpress.SDK.Client.Test.Api
{
    ...
    public class TransactionApiTests : IDisposable
    {
        ...
        public void GetAllTransactionsTest()
        {
            ...
            //int? pageSize = null;
            //string sortBy = null;
            //var response = instance.GetAllTransactions(transactionStatus, transactionStatusComparison, starkexTxId, starkexTxIdComparison, txType, txTypeComparison, pageNumber, pageSize, sortBy);
