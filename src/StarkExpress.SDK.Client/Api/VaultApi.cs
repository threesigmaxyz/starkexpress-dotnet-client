...
namespace StarkExpress.SDK.Client.Api
{
    ...
    public interface IVaultApiSync : IApiAccessor
    {
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>VaultDto</returns>
        VaultDto GetVault(Guid vaultId, int operationIndex = 0);
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>ApiResponse of VaultDto</returns>
        ApiResponse<VaultDto> GetVaultWithHttpInfo(Guid vaultId, int operationIndex = 0);
    ...
    public interface IVaultApiAsync : IApiAccessor
    {
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of VaultDto</returns>
        System.Threading.Tasks.Task<VaultDto> GetVaultAsync(Guid vaultId, int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken));
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse (VaultDto)</returns>
        System.Threading.Tasks.Task<ApiResponse<VaultDto>> GetVaultWithHttpInfoAsync(Guid vaultId, int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken));
    ...
    public partial class VaultApi : IVaultApi
    {
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>VaultDto</returns>
        public VaultDto GetVault(Guid vaultId, int operationIndex = 0)
        {
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>ApiResponse of VaultDto</returns>
        public StarkExpress.SDK.Client.Client.ApiResponse<VaultDto> GetVaultWithHttpInfo(Guid vaultId, int operationIndex = 0)
        {
            StarkExpress.SDK.Client.Client.RequestOptions localVarRequestOptions = new StarkExpress.SDK.Client.Client.RequestOptions();
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of VaultDto</returns>
        public async System.Threading.Tasks.Task<VaultDto> GetVaultAsync(Guid vaultId, int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            StarkExpress.SDK.Client.Client.ApiResponse<VaultDto> localVarResponse = await GetVaultWithHttpInfoAsync(vaultId, operationIndex, cancellationToken).ConfigureAwait(false);
            return localVarResponse.Data;
        }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse (VaultDto)</returns>
        public async System.Threading.Tasks.Task<StarkExpress.SDK.Client.Client.ApiResponse<VaultDto>> GetVaultWithHttpInfoAsync(Guid vaultId, int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
