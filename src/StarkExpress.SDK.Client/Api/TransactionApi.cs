...
namespace StarkExpress.SDK.Client.Api
{
    ...
    public partial class TransactionApi : ITransactionApi
    {
        ...
        public StarkExpress.SDK.Client.Client.ApiResponse<TransactionDtoPaginatedResponseDto> GetAllTransactionsWithHttpInfo(int pageNumber, int pageSize, TransactionStatus? transactionStatus = default(TransactionStatus?), FilterOptions? transactionStatusComparison = default(FilterOptions?), int? starkexTxId = default(int?), FilterOptions? starkexTxIdComparison = default(FilterOptions?), string sortBy = default(string), int operationIndex = 0)
        {
            ...
            var localVarResponse = this.Client.Get<TransactionDtoPaginatedResponseDto>("/api/transactions", localVarRequestOptions, this.Configuration);
        ...
        public async System.Threading.Tasks.Task<StarkExpress.SDK.Client.Client.ApiResponse<TransactionDtoPaginatedResponseDto>> GetAllTransactionsWithHttpInfoAsync(int pageNumber, int pageSize, TransactionStatus? transactionStatus = default(TransactionStatus?), FilterOptions? transactionStatusComparison = default(FilterOptions?), int? starkexTxId = default(int?), FilterOptions? starkexTxIdComparison = default(FilterOptions?), string sortBy = default(string), int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            ...
            // make the HTTP request
            var localVarResponse = await this.AsynchronousClient.GetAsync<TransactionDtoPaginatedResponseDto>("/api/transactions", localVarRequestOptions, this.Configuration, cancellationToken).ConfigureAwait(false);
        ...
        public StarkExpress.SDK.Client.Client.ApiResponse<TransactionDto> GetTransactionWithHttpInfo(Guid transactionId, int operationIndex = 0)
        {
            ...
            // make the HTTP request
            var localVarResponse = this.Client.Get<TransactionDto>("/api/transactions/{transactionId}", localVarRequestOptions, this.Configuration);
            if (this.ExceptionFactory != null)
            {
        ...
        public async System.Threading.Tasks.Task<StarkExpress.SDK.Client.Client.ApiResponse<TransactionDto>> GetTransactionWithHttpInfoAsync(Guid transactionId, int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            ...
            // make the HTTP request
            var localVarResponse = await this.AsynchronousClient.GetAsync<TransactionDto>("/api/transactions/{transactionId}", localVarRequestOptions, this.Configuration, cancellationToken).ConfigureAwait(false);
