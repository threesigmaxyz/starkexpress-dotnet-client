...
namespace StarkExpress.SDK.Client.Model
{
    ...
    public partial class VaultDto : IEquatable<VaultDto>, IValidatableObject
    {
        ...
        /// <param name="assetId">The StarkExpress ID of the asset associated with the vault..</param>
        ...
        public VaultDto(Guid vaultId = default(Guid), string vaultChainId = default(string), string starkExAddress = default(string), string assetId = default(string), string assetSymbol = default(string), string assetStarkExId = default(string), string userStarkKey = default(string), string availableBalance = default(string), string accountingBalance = default(string))
        {
        ...
        /// <summary>
        /// The StarkExpress ID of the asset associated with the vault.
        /// </summary>
        /// <value>The StarkExpress ID of the asset associated with the vault.</value>
