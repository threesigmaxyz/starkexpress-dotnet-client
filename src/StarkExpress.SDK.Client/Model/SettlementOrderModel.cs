...
namespace StarkExpress.SDK.Client.Model
{
    ...
    public partial class SettlementOrderModel : IEquatable<SettlementOrderModel>, IValidatableObject
    {
        ...
        /// Initializes a new instance of the <see cref="SettlementOrderModel" /> class.
        /// </summary>
        /// <param name="buyVaultId">The unique identifier of the transfer sender vault. (required).</param>
        /// <param name="buyQuantizedAmount">The amount of the asset to be transferred, in quantized form. (required).</param>
        /// <param name="sellVaultId">The unique identifier of the transfer sender vault. (required).</param>
        /// <param name="sellQuantizedAmount">The amount of the asset to be transferred, in quantized form. (required).</param>
        ...
        public SettlementOrderModel(Guid buyVaultId = default(Guid), string buyQuantizedAmount = default(string), Guid sellVaultId = default(Guid), string sellQuantizedAmount = default(string), Guid? feeVaultId = default(Guid?), string feeQuantizedAmount = default(string), int nonce = default(int), SignatureModel signature = default(SignatureModel), long expirationTimestamp = default(long), SpotOrderRequestType? type = default(SpotOrderRequestType?))
        {
