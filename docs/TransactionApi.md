...
namespace Example
{
    public class GetAllTransactionsExample
    {
        public static void Main()
        {
            ...
            var pageSize = 56;  // int | 
            var transactionStatus = (TransactionStatus) "null";  // TransactionStatus? |  (optional) 
            var transactionStatusComparison = (FilterOptions) "null";  // FilterOptions? |  (optional) 
            var starkexTxId = 56;  // int? |  (optional) 
            var starkexTxIdComparison = (FilterOptions) "null";  // FilterOptions? |  (optional) 
